...
\atsameer{We've already chatted about the different assumed equilibriums in-depth, but to be extra safe please check the immediately preceding two sentences.}
...
Jane mentioned that this wavelength resolution is not typical for COS.
Is there a motivation for choosing this to be the default value for trident?}
...
\subsection[Spectra of high-resolution turbulence --- \texttt{sample2}]{Spectra of high-resolution turbulence --- \texttt{sample2}\footnote{
...
while Figures~\ref{f: summary--average} and~\ref{f: summary--widths} summarize some key results.
...
% Figure description
\todo{Add Figure~\ref{f: sample1 violin} description.}
...
\subsection{Spectra of high-resolution turbulence --- \texttt{sample2}}
...
\begin{figure*}
    ...
    \todo{Consider condensing this, both by plotting only the 1D distributions and by considering a way to show the blinded and revised estimates on a single plot.}
