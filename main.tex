...
% Multiple components and cloudlets
Many absorption spectra are best fit by multiple components~\citep[e.g.][]{Muzahid2015}.
...
% Mock spectra
Synthetic spectra of absorption systems~\citep[e.g.][]{Hummels2013} are one method to test the robustness of observational methods~\citep[e.g.][]{Churchill2015}.
...
\subsubsection{For analyses that infer a physical picture from individual sightlines}
