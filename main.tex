...
\todo{What are some scenarios where you simply do not have the data to model them successfully?}
...
\begin{enumerate}
    ...
    \item \textbf{Posterior distributions:} Even when the best fits do not agree with the source parameters, the source parameters typically lie within the 16th to 84th percentiles of the posterior distribution, suggesting errors are typically sufficiently conservative (Figure~\ref{f: summary--widths}).
