...
\begin{figure*}
    ...
    For the revised parameter estimation we also show the posteriors for the individual clouds as blue lines outlined in black,
    limiting the display to the region enclosing 99.7\% of the posterior for a given cloud.
    }
    \label{f: sample2 12}
\end{figure*}
