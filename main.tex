...
in support of observational constraints requiring small, dense clouds.
...
\todo{Add in references suggested by Jane: Anything showing many low ionization systems at high resolution, e.g. \url{ https://ui.adsabs.harvard.edu/abs/2001AJ....122..679C/abstract},\url{https://ui.adsabs.harvard.edu/abs/1999ApJS..120...51C/abstract}.}
...
\begin{enumerate}
    ...
    \item \todo{Depending on what we settle on, comment on the possible need for high spatial resolution.}
\end{enumerate}
