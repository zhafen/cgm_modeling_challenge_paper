...
and as such fundamentally cannot constrain cloud structure regarding distribution shape.
This is an area of future work that some alternative parameter-estimation methods address this~\citep[e.g.][]{stern2016Universal}.
...
Utilizing multiple Lyman-series lines reduces the contamination of noise in identifying coincident-in-velocity-absorption.
...
\subsubsection{Discrete components versus a distributions of clouds}
