...
%    The blinded parameter estimates assumed cooling-heating equilibrium,
...
In this sightline, the data is best fit by two clouds, one with significant low-ion absorption (e.g. \ion{C}{III})  and one with significant high-ion absorption (e.g. \ion{O}{VI}).
