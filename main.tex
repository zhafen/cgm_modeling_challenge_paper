...
\begin{enumerate}
    \item New Figure 6 and Figure 8.
    \item Time for another pass. Sameer and Jane in particular.
    \item Given the challenge in recovering the shape of cloud distributions, how important is it for simulators to resolve parsec-scale gas?
\end{enumerate}
